...
def preprocess_data(raw_data):
    ...
    stocks["Portfolio_Diversity"] = round(stocks["Market_Value"] * 100 / stocks["Market_Value"].sum(), 2)
    stocks["Direction"] = stocks["Percent_Change"].apply(lambda x: "Up" if x > 0 else "Down")
